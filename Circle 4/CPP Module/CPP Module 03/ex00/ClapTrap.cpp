...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/27 20:20:39 by hyeondle          #+#    #+#             */
/*   Updated: 2023/05/27 20:20:39 by hyeondle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap()
{
	std::cout << "\e[0;31mDestructor called\e[0m" << " Name : " << this->name << std::endl;
}
// Operators
...
{
	std::cout << "ClapTrap " << getName() << " is dead. Can't do anything" << std::endl;
}
void	ClapTrap::noEnergy(void)
{
	std::cout << "ClapTrap " << getName() << " has no more energy." << std::endl;
}
//	Functions(Public)
void	ClapTrap::displayState(void)
{
	std::cout << "ClapTrap " << getName() << "\'s statement" << std::endl;
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "ClapTrap " << getName() << " lose " << amount << " hit point!" << std::endl;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (statecheck())
		return ;
	std::cout << "ClapTrap " << getName() << " restored " << amount << " hit point!" << std::endl;
	setHitPoint(getHitPoint() + amount);
	setEnergyPoint(getEnergyPoint() - 1);
}